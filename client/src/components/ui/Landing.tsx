...
export default function Landing() {
  ...
  return (
    <div className="flex h-full flex-col items-center overflow-y-auto pt-0 text-sm dark:bg-stone-950">
      <div className="w-full px-6 text-gray-800 dark:text-white md:flex md:max-w-2xl md:flex-col lg:max-w-3xl">
        <h1
          id="landing-title"
          className="mb-2 ml-auto mr-auto mt-6 flex items-center justify-center gap-2 text-center text-4xl font-semibold sm:mb-2 md:mt-[5vh]"
        >
          {config?.appTitle || 'LibreChat'}
        </h1>
        <div class="flex justify-center"><img src="/assets/logo.png" width="120" class="text-center" alt="AI Engineer logo"/></div>
        <h6 class="text-center text-lg mb-8">Sometimes it whisper to my soul</h6>
        ...
        {/* <div className="group h-32 w-full flex-shrink-0 dark:border-gray-900/50 dark:bg-stone-950 md:h-48" /> */}
      </div>
    </div>
  );
}
